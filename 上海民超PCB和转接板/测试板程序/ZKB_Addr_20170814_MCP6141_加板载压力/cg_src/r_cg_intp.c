...
void R_INTC0_Start(void)
{
    ...
    PMK0 = 0U;    /* enable INTP7 interrupt */
}
void R_INTC0_Stop(void)
{
    PMK0 = 1U;    /* disable INTP7 interrupt */
    PIF0 = 0U;    /* clear INTP7 interrupt flag */
}
void R_INTC1_Start(void)
{
    PIF1 = 0U;    /* clear INTP7 interrupt flag */
    PMK1 = 0U;    /* enable INTP7 interrupt */
}
void R_INTC1_Stop(void)
{
    PMK1 = 1U;    /* disable INTP7 interrupt */
    PIF1 = 0U;    /* clear INTP7 interrupt flag */
}
void R_INTC2_Start(void)
{
    PIF2 = 0U;    /* clear INTP7 interrupt flag */
    PMK2 = 0U;    /* enable INTP7 interrupt */
}
void R_INTC2_Stop(void)
{
    PMK2 = 1U;    /* disable INTP7 interrupt */
    PIF2 = 0U;    /* clear INTP7 interrupt flag */
}
void R_INTC6_Start(void)
{
    PIF6 = 0U;    /* clear INTP7 interrupt flag */
    PMK6 = 0U;    /* enable INTP7 interrupt */
}
void R_INTC6_Stop(void)
{
    PMK6 = 1U;    /* disable INTP7 interrupt */
    PIF6 = 0U;    /* clear INTP7 interrupt flag */
}

void R_INTC3_Start(void)
{
    PIF3 = 0U;    /* clear INTP7 interrupt flag */
    PMK3 = 0U;    /* enable INTP7 interrupt */
}
void R_INTC3_Stop(void)
{
    PMK3 = 1U;    /* disable INTP7 interrupt */
    PIF3 = 0U;    /* clear INTP7 interrupt flag */
}

void R_INTC4_Start(void)
{
    PIF4 = 0U;    /* clear INTP7 interrupt flag */
    PMK4 = 0U;    /* enable INTP7 interrupt */
}
void R_INTC4_Stop(void)
{
    PMK4 = 1U;    /* disable INTP7 interrupt */
    PIF4 = 0U;    /* clear INTP7 interrupt flag */
}
void R_INTC5_Start(void)
{
    PIF5 = 0U;    /* clear INTP7 interrupt flag */
    PMK5 = 0U;    /* enable INTP7 interrupt */
}
void R_INTC5_Stop(void)
{
    PMK5 = 1U;    /* disable INTP7 interrupt */
    PIF5 = 0U;    /* clear INTP7 interrupt flag */
}
/* End user code. Do not edit comment generated here */
