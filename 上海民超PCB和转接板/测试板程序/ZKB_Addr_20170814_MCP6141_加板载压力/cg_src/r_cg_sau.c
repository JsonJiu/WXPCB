...
void R_UART0_Create(void)
{
    ...
    /* Set INTST0 low priority *///fasong de chuan song jieshu zhongduan
    STPR10 = 1U;
    STPR00 = 1U;
    /* Set INTSR0 low priority *///jieshou de chuan song jieshu zhongduan
    SRPR10 = 1U;
    SRPR00 = 1U;
    SMR00 = _0020_SAU_SMRMN_INITIALVALUE | _0000_SAU_CLOCK_SELECT_CK00 | _0000_SAU_TRIGGER_SOFTWARE | //chuanghang moshi ji cun qi
            _0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END;
    SCR00 = _8000_SAU_TRANSMISSION | _0000_SAU_INTSRE_MASK | _0000_SAU_PARITY_NONE | _0080_SAU_LSB | //chuanhang tongxing sheding ji cun qi
            _0010_SAU_STOP_1 | _0007_SAU_LENGTH_8;
    SDR00 = _CE00_UART0_TRANSMIT_DIVISOR;
    NFEN0 |= _01_SAU_RXD0_FILTER_ON;//zao sheng lv bo qi dakai
...
void R_UART1_Create(void)
{
    ...
    SMR02 = _0020_SAU_SMRMN_INITIALVALUE | _0000_SAU_CLOCK_SELECT_CK00 | _0000_SAU_TRIGGER_SOFTWARE | 
            _0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END;
    SCR02 = _8000_SAU_TRANSMISSION | _0000_SAU_INTSRE_MASK | _0200_SAU_PARITY_EVEN | _0080_SAU_LSB | 
            _0010_SAU_STOP_1 | _0007_SAU_LENGTH_8;
    ...
    SMR03 = _0020_SAU_SMRMN_INITIALVALUE | _0000_SAU_CLOCK_SELECT_CK00 | _0100_SAU_TRIGGER_RXD | _0000_SAU_EDGE_FALL | 
            _0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END;
    SCR03 = _4000_SAU_RECEPTION | _0000_SAU_INTSRE_MASK | _0200_SAU_PARITY_EVEN | _0080_SAU_LSB | _0010_SAU_STOP_1 | 
            _0007_SAU_LENGTH_8;
...
void R_SAU1_Create(void)
{
    ...
    NOP();
    NOP();
    SPS1 = _0002_SAU_CK00_FCLK_2 | _0040_SAU_CK01_FCLK_4;
    R_UART2_Create();
    R_UART3_Create();
}
/***********************************************************************************************************************
...
{
    STIF1 = 0U;    /* clear INTST1 interrupt flag */
    STMK1 = 1U;    /* enable INTST1 interrupt */
    SRIF1 = 0U;    /* clear INTSR1 interrupt flag */
...
void CARD_EN(unsigned char CARDEND)
{
	if(CARDEND)
	{
		SRIF0 = 0U;
...
void IRDA_EN(unsigned char IRDAEND)
{
	if(IRDAEND)
	{
		SRIF3 = 0U;
...
void ZJ_EN(unsigned char ZJEND)
{
  if(ZJEND)
  {
    SRIF2 = 0U;
...
void UMU_EN(unsigned char UNUEND)
{
  if(UNUEND)
  {
    SRIF1 = 0U;
